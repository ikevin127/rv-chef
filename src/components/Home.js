          ...
          <div className="h-nav">
            <ul className="nav-list">
              <span
                ...
                className="btn-la"
              >
                {this.state.change ? "Înapoi" : "LaPachet"}
              </span>
            ...
            {this.state.pachet ? (
              ...
              <>
                <div className="card5">
                  ...
                  <h1 id="title1">Ciorbă de ridichi</h1>
                  <span id="line" />
                  <p id="text">O ciorbă ca la mama acasă, reţetă secretă.</p>
                  <span id="line" />
                  <h1 id="title1">Preţ: 10RON</h1>
                  <span
                    onClick={() => {
                      alert("checkout");
                    }}
            ...
            <div className="home-wrapper">
              ...
              <div ref={this.aboutRef} className="about-chef">
                ...
                <div className="about-text">
                  ...
                  <p id="text">
                    Bucătar şef la Roca Brună, tânărul Raul Vidican a lucrat
                    câțiva ani în restaurante din Germania, perioadă în care a
                    ajuns să se califice în semifinalele regionale ale
                    competiției S.Pellegrino Young Chef 2018, concurând pentru
                    regiunea Germania - Austria. Reîntors în țară, a colaborat
                    cu mai multe restaurante din zona Transilvaniei, pentru ca
                    anul trecut să se implice în proiectul Roca Brună.
                    <br />
                    <br />
                    „Roca Brună este unul din motivele întoarcerii mele în țară,
                    discutam cu Dan despre acest proiect încă de când lucram în
                    Germania. Nu am stat prea mult pe gânduri să mă alătur,
                    pentru că este un restaurant exact cum îmi doresc și este
                    acasă. Este tot ce aveam nevoie. Meniul restaurantului este
                    destul de simplu: se schimbă în funcție de sezon și ținem
                    cont de ce putem achiziționa de la producătorii locali.
                    Încet, încet am început să dezvoltăm mai mult meniul, să
                    oferim clienților diverse combinații de mâncare, mai altfel.
                    Un astfel de exemplu este preparatul realizat din piept și
                    pulpe de rață gătite confit, trase apoi într-o crustă de
                    panko, servite cu piure de migdale, ciuperci la tigaie și o
              ...
              <Parallax className="parallax3" bgImage={img3} strength={400}>
                ...
                >
                  <div className="card1">
                    ...
                    <p id="text">
                      Raul Vidican este un tanar de o valoare inestimabila, cu
                      viziuni inalte si potential inegalabil...Raul te felicit
                      si te urmaresc cu mult interes!!!!!
                    </p>
                    <span id="line" />
                  ...
                  <div className="card2">
                    ...
                    <p id="text">
                      Un chef cu o personalitate demna de toate laudele. Mult
                      succes!
                    </p>
                    <span id="line" />
                    <div className="media2">
                  ...
                  <div className="card3">
                    ...
                    <p id="text">
                      Un om valoros si talentat care pune pasiune si transforma
                      orice aliment in arta!
                    </p>
                    <span id="line" />
                    <div className="media2">
                  ...
                  <div className="card5">
                    ...
                    <p id="text">
                      Un bucatar excelent cu rafinament , simplitate si gust
                      ..demn de un succes maret
                    </p>
                    <span id="line" />
                    <div className="media2">
                      <img
...
Adelina Iancu"
              ...
              <div className="footer">
                <div className="footer-data">
                  ...
                  <p id="contact-data">
                    Tel: 0751 988 273 | Email: info@mysite.com
                  </p>
                  <p id="copy">
                    {currentYear} &copy;{" "}
